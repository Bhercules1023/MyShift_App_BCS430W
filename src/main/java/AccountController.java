...
public class AccountController {
    ...
    private void updateUsername() throws IOException {
        ...
        String updateUsername = "UPDATE Employees SET username = ? WHERE ID = ? AND username = ?";
    ...
    private void updatePassword() throws IOException {
        ...
        String updatePassword = "UPDATE Employees SET password = ? WHERE ID = ? AND username = ?";
    ...
    private void updateEmail() throws IOException {
        ...
        String updateEmail = "UPDATE Employees SET Email = ? WHERE ID = ? AND username = ?";
    ...
    private void updateAdminUsername() throws IOException{
        ...
        String updateUsername = "UPDATE Management SET username = ? WHERE ID = ? AND adminUsername = ?";
    ...
    private void updateAdminPassword() throws IOException {
        ...
        String updatePassword = "UPDATE Management SET password = ? WHERE ID = ? AND adminUsername = ?";
    ...
    private void updateAdminEmail() throws IOException {
        ...
        String updateEmail = "UPDATE Management SET Email = ? WHERE ID = ? AND adminUsername = ?";
